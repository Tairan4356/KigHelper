...
**娃语** 深度适配了 **锁屏显示 Activity** 功能。**无需解锁手机，点亮屏幕即可直接使用预设语，真正做到“即开即说”。
**
...
- 🔔 **实况通知与状态栏上岛**：常驻后台时自动开启实况通知，适配各系统灵动岛或状态栏胶囊设计，实现高频交互时“秒回”应用。
- 🎙️ **离线语音与调音**：集成 **Sherpa-Onnx** 引擎，支持本地导入语音模型。提供对语调、语速及起伏度等多维度的精细调校，让角色拥有最贴合人设的声线。
...
- **演示视频**：[点击查看视频演示](https://www.bilibili.com/av116498135783607)
- **作者 B 站主页**：[@麒格Ler](https://space.bilibili.com/353197379)
- **QQ 交流群**：`1103795582`（[点击一键加入交流群](https://qm.qq.com/q/qqN05HHWDK)）

### 界面展示

<table>
  <tr>
    <td><img src="docs/screenshots/main.jpg" width="200" alt="Main Screen"></td>
    <td><img src="docs/screenshots/input.jpg" width="200" alt="Input Screen"></td>
    <td><img src="docs/screenshots/edit.jpg" width="200" alt="Edit Screen"></td>
  </tr>
  <tr>
...
更多界面截图见 [docs/screenshots/](docs/screenshots/) 文件夹。

## 📝 TODO 路线图

以下功能已列入画饼（划掉）计划，优先级从高到低：

- [ ] **多语言支持**：支持更多语言的界面和语音输出。
...
- [x] **振动反馈**：点击时提供触觉反馈。
- [x] **横屏适配**：支持横屏/平板使用。
- [x] **离线语音**：集成 Sherpa ONNX，支持本地模型导入、精细参数调校及更自然的语音输出。
- [x] **短语分类**：支持对短语进行分组。
- [x] **偏好设置**：自定义字体大小、配色等。
- [x] **音频导入**：支持播放自定义音频文件。
- [x] **导入导出预设**：允许导出和导入自己的短语设置。
- [x] **扩列卡片**：支持快速弹出个人社交账号或二维码
...
我们非常致敬社区先行者的贡献。如果 **娃语** 无法满足您的所有需求，也推荐尝试上述同类软件。
